...
class Game(object):
    ...
    def __init__(self):
        ...
        self.clockImg = Images(
            self.screen, 'images/clock.png', pos=vec2d(430, 0))
        ...
        self.field_rect = pygame.Rect(0, 0, self.SCREEN_WIDTH,
                                      self.SCREEN_HEIGHT)
